...
class Task(db.Model):
    ...
    agent = db.Column(db.String(100), nullable=False) # The agent responsible for the task
    ...
    context = db.Column(db.String(200), nullable=True) # Specifies tasks whose ouputs are used as inputs to this task
